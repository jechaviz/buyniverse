...
class SiteManagementController extends Controller
{
    ...
    public function settings()
    {
        ...
        $footer_bg = !empty($footer_settings['footer_bg']) ? $footer_settings['footer_bg'] : null;
        $footer_desc = !empty($footer_settings['description']) ? $footer_settings['description'] : null;
        $footer_copyright = !empty($footer_settings['copyright']) ? $footer_settings['copyright'] : 'Buyniverse. All Rights Reserved.';
        ...
        $f_logo = !empty($inner_page) && !empty($inner_page[0]['f_logo']) ? $inner_page[0]['f_logo'] : null;
        $e_inner_banner = !empty($inner_page) && !empty($inner_page[0]['e_inner_banner']) ? $inner_page[0]['e_inner_banner'] : null;
        $e_logo = !empty($inner_page) && !empty($inner_page[0]['e_logo']) ? $inner_page[0]['e_logo'] : null;
        $job_inner_banner = !empty($inner_page) && !empty($inner_page[0]['job_inner_banner']) ? $inner_page[0]['job_inner_banner'] : null;
        $job_logo = !empty($inner_page) && !empty($inner_page[0]['job_logo']) ? $inner_page[0]['job_logo'] : null;
        ...
        $service_logo = !empty($inner_page) && !empty($inner_page[0]['service_logo']) ? $inner_page[0]['service_logo'] : null;
        ...
        $article_logo = !empty($inner_page) && !empty($inner_page[0]['article_logo']) ? $inner_page[0]['article_logo'] : null;
        ...
        $selected_header = !empty($settings[0]['header_style']) ? $settings[0]['header_style'] : 'style1' ;
        $selected_footer = !empty($footer_settings['footer_style']) ? $footer_settings['footer_style'] : 'style1';
        $f_selected_header = !empty($inner_page) && !empty($inner_page[0]['f_header_style']) ? $inner_page[0]['f_header_style'] : 'style1';
        $emp_selected_header = !empty($inner_page) && !empty($inner_page[0]['emp_header_style']) ? $inner_page[0]['emp_header_style'] : 'style1';
        ...
        if (file_exists(resource_path('views/extend/back-end/admin/settings/index.blade.php'))) {
            return view(
                ...
                compact(
                    ...
                    'footer_bg', 'footer_desc', 'social_list', 'social_unserialize_array',
                    ...
                    'stripe_secret','stripe_img', 'languages', 'selected_language', 'reg_one_title',
    ...
    public function homePageSettings()
    {
        ...
        $banner_title = !empty($home_settings[0]['banner_title']) ? $home_settings[0]['banner_title'] : 'Hire expert providers';
    ...
    public function getInnerPageSettings(Request $request)
    {
        ...
        $json['f_menu_color'] = !empty($inner_page_settings[0]['f_menu_color']) ? $inner_page_settings[0]['f_menu_color'] : '';
        $json['f_hover_color'] = !empty($inner_page_settings[0]['f_hover_color']) ? $inner_page_settings[0]['f_hover_color'] : '';
        $json['f_header_style'] = !empty($inner_page_settings[0]['f_header_style']) ? $inner_page_settings[0]['f_header_style'] : 'style1';
        $json['emp_header_style'] = !empty($inner_page_settings[0]['emp_header_style']) ? $inner_page_settings[0]['emp_header_style'] : 'style1';
        $json['job_header_style'] = !empty($inner_page_settings[0]['job_header_style']) ? $inner_page_settings[0]['job_header_style'] : 'style1';
        $json['service_header_style'] = !empty($inner_page_settings[0]['service_header_style']) ? $inner_page_settings[0]['service_header_style'] : 'style1';
        $json['article_header_style'] = !empty($inner_page_settings[0]['article_header_style']) ? $inner_page_settings[0]['article_header_style'] : 'style1';
        if (!empty($inner_page_settings[0]['show_emp_banner'])) {
            if ($inner_page_settings[0]['show_emp_banner'] == 'true') {
                $json['show_emp_banner'] = 'true';
            }
        }
        if (!empty($inner_page_settings[0]['employer_header_styling'])) {
            if ($inner_page_settings[0]['employer_header_styling'] == 'true') {
                $json['employer_header_styling'] = 'true';
            }
        }
        if (!empty($inner_page_settings[0]['job_header_styling'])) {
            if ($inner_page_settings[0]['job_header_styling'] == 'true') {
                $json['job_header_styling'] = 'true';
            }
        }
        if (!empty($inner_page_settings[0]['service_header_styling'])) {
            if ($inner_page_settings[0]['service_header_styling'] == 'true') {
                $json['service_header_styling'] = 'true';
            }
        }
        if (!empty($inner_page_settings[0]['article_header_styling'])) {
            if ($inner_page_settings[0]['article_header_styling'] == 'true') {
                $json['article_header_styling'] = 'true';
            }
        }
        $json['e_menu_text_color'] = !empty($inner_page_settings[0]['e_menu_text_color']) ? $inner_page_settings[0]['e_menu_text_color'] : '';
        $json['e_menu_color'] = !empty($inner_page_settings[0]['e_menu_color']) ? $inner_page_settings[0]['e_menu_color'] : '';
        $json['e_hover_color'] = !empty($inner_page_settings[0]['e_hover_color']) ? $inner_page_settings[0]['e_hover_color'] : '';
        $json['job_menu_text_color'] = !empty($inner_page_settings[0]['job_menu_text_color']) ? $inner_page_settings[0]['job_menu_text_color'] : '';
        $json['job_menu_color'] = !empty($inner_page_settings[0]['job_menu_color']) ? $inner_page_settings[0]['job_menu_color'] : '';
        $json['job_hover_color'] = !empty($inner_page_settings[0]['job_hover_color']) ? $inner_page_settings[0]['job_hover_color'] : '';
        $json['service_menu_text_color'] = !empty($inner_page_settings[0]['service_menu_text_color']) ? $inner_page_settings[0]['service_menu_text_color'] : '';
        $json['service_menu_color'] = !empty($inner_page_settings[0]['service_menu_color']) ? $inner_page_settings[0]['service_menu_color'] : '';
        $json['service_hover_color'] = !empty($inner_page_settings[0]['service_hover_color']) ? $inner_page_settings[0]['service_hover_color'] : '';
        $json['article_menu_text_color'] = !empty($inner_page_settings[0]['article_menu_text_color']) ? $inner_page_settings[0]['article_menu_text_color'] : '';
        $json['article_menu_color'] = !empty($inner_page_settings[0]['article_menu_color']) ? $inner_page_settings[0]['article_menu_color'] : '';
        $json['article_hover_color'] = !empty($inner_page_settings[0]['article_hover_color']) ? $inner_page_settings[0]['article_hover_color'] : '';
        ...
        if (!empty($inner_page_settings[0]['add_f_navbar'])) {
            if ($inner_page_settings[0]['add_f_navbar'] == 'true') {
                $json['add_f_navbar'] = 'true';
            }
        } else {
            $json['add_f_navbar'] = 'true';
        }
        if (!empty($inner_page_settings[0]['add_emp_navbar'])) {
            if ($inner_page_settings[0]['add_emp_navbar'] == 'true') {
                $json['add_emp_navbar'] = 'true';
            }
        } else {
            $json['add_emp_navbar'] = 'true';
        }
        if (!empty($inner_page_settings[0]['add_job_navbar'])) {
            if ($inner_page_settings[0]['add_job_navbar'] == 'true') {
                $json['add_job_navbar'] = 'true';
            }
        } else {
            $json['add_job_navbar'] = 'true';
        }
        if (!empty($inner_page_settings[0]['add_service_navbar'])) {
            if ($inner_page_settings[0]['add_service_navbar'] == 'true') {
                $json['add_service_navbar'] = 'true';
            }
        } else {
            $json['add_service_navbar'] = 'true';
        }
        if (!empty($inner_page_settings[0]['add_article_navbar'])) {
            if ($inner_page_settings[0]['add_article_navbar'] == 'true') {
                $json['add_article_navbar'] = 'true';
            }
        } else {
            $json['add_article_navbar'] = 'true';
        }
    ...
    {
        $path = Helper::assetPath() . '/uploads/settings/temp/';
        //dd($path);
