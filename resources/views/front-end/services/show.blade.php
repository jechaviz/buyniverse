...
@section('description', strip_tags( html_entity_decode( $service->description)))
@section('content')
    ...
    @if (file_exists(resource_path('views/extend/front-end/includes/inner-banner.blade.php')))
        @include('extend.front-end.includes.inner-banner', 
            ['title' => trans('lang.service_detail'), 'inner_banner' => $service_inner_banner, 'show_banner' => $show_service_banner  ]
        )
    @else 
