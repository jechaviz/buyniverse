...
@section('content')
    @php
        $role = 'employer';
        $breadcrumbs = Breadcrumbs::generate('showUserProfile', $user->slug, $role); 
    @endphp
    ...
    <div class="wt-main-section wt-haslayout la-profile-holder" id="user_profile" style="padding: 0;">
                            ...
                            <div class="wt-proposalsr wt-proposalsrvtwo">
                                <div class="wt-widgetcontent wt-companysinfo">
                                    ...
                                    <div class="wt-title">
                                        ...
                                        @endif
                                        <h2>{{{ $user_name }}}</h2>
                                        <a href="{{ url('profile/'.$user->slug.'/freelancer') }}" id="freelancer-51" class="wt-clicksavebtn" style="padding: 5px 5px;margin-top: 20px;"><i></i>
                                        Freelancer
                                    </a>
                                    </div>
                                </div>
                        ...
                        <div class="wt-userlistingholder wt-haslayout">
                            <div class="wt-comcontent">
                                <div class="wt-title row">
                                    <h3 class="col-md-10">{{ trans('lang.about') }} “{{{ $user_name }}}”</h3>
