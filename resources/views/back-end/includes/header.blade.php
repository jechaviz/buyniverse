@if (Schema::hasTable('users'))
    ...
    @if (!empty($slider) && $slider['index'] == 0) 
        @if (!empty($slider['style']) && $slider['style'] == 'style3')
            <header id="wt-header" class="wt-header wt-headervfour wt-haslayout" style="z-index:11;">
        ...
        @else
            <header id="wt-header" class="wt-header wt-haslayout {{$inner_header}}"  style="z-index:11;">
                <div class="wt-navigationarea">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                ...
                                @auth
                                    ...
                                    @endphp
                                        ...
                                        <div class="wt-userlogedin">
                                            <figure class="wt-userimg">
                                                {{-- <img src="{{{ asset($profile_image) }}}" alt="{{{ trans('lang.user_avatar') }}}"> --}}
                                                <!--<img src="{{{ url(Helper::getImage('public/uploads/users/' . Auth::user()->id, $profile->avater, '' , 'user.jpg')) }}}" alt="{{{ trans('lang.user_avatar') }}}">-->
                                                <img src="{{{ asset(Helper::getProfileImage(Auth::user()->id, '')) }}}" alt="{{{ trans('lang.user_avatar') }}}">
                                            </figure>
                                            <div class="wt-username">
                                                <h3>{{{ Helper::getUserName(Auth::user()->id) }}}</h3>
    ...
    @if (!empty(Route::getCurrentRoute()) && Route::getCurrentRoute()->uri() != '/' && Route::getCurrentRoute()->uri() != 'home')
                                    ...
                                    <div id="navbarNav1" class="collapse navbar-collapse wt-navigation" style="float: right;background-color: rgb(0, 81, 120);">
                                        <ul class="navbar-nav"> 
                                            ...
                                            <li style="line-height: 13px!important;font-size: small;">
                                                ...
                                                <a class="header-menu-a" style="margin-top: 5px;margin-bottom: 5px;">{{ trans('lang.services')}}<i class="ti-angle-down"></i></a>
                                                <ul class="sub-menu">
                                                    <li><a href="{{{ route('employerServices') }}}">{{ trans('lang.services') }}</a></li>
        ...
        <script>
            ...
            {
                //console.log(document.getElementById("wt-sidebarwrapper").style.display);
                if(document.getElementById("wt-sidebarwrapper").style.display == 'none')
                    document.getElementById("wt-sidebarwrapper").style.display = 'block';
                else
                    document.getElementById("wt-sidebarwrapper").style.display = 'none';
            }
            function openham1() 
            {
                if(document.getElementById("navbarNav1").style.display == 'none')
                    document.getElementById("navbarNav1").style.display = 'block!important';
                else
                    document.getElementById("navbarNav1").style.display = 'none!important';
            }
