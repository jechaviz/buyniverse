@auth
    <div id="wt-sidebarwrapper" class="wt-sidebarwrapper" style="display:none;">
        ...
        @php
            ...
            $copyright = !empty($setting) ? $setting['copyright'] : 'Buyniverse All Rights Reserved';
        @endphp
        <div id="wt-verticalscrollbar" class="wt-verticalscrollbar">
            <div class="wt-companysdetails wt-usersidebar" style="display:none;">
            ...
            <nav id="wt-navdashboard" class="wt-navdashboard">
                <ul>
                    ...
                    @if ($role === 'employer' || $role === 'provider' )
                        ...
                        <li>
                            <a href="{{{ url($user->role.'/dashboard') }}}">
                        ...
                        @if ($user->role === 'employer')
                            @if (Helper::getAccessType() == 'both' || Helper::getAccessType() == 'jobs')
                                ...
                                <li>
                                    <a href="{{{ route('buy') }}}">
                                        <i class="ti-money"></i>
                                        <span>{{ trans('lang.buy')}}</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="">
                                        <i class="ti-target"></i>
                                        <span>{{ trans('lang.sell')}}</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="">
                                        <i class="ti-briefcase"></i>
                                        <span>{{ trans('lang.business')}}</span>
                                    </a>
                                </li>
                            @endif
                            @if (Helper::getAccessType() == 'both' || Helper::getAccessType() == 'services')
                        ...
                        @elseif ($user->role === 'provider')
                            ...
                            <li>
                                <a href="{{{ route('fteam.index') }}}">
                                    <i class="ti-bookmark-alt"></i>
                                    <span> {{ trans('lang.team') }}</span>
                                </a>
                            </li>
                            <li>
