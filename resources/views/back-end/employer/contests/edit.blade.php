                        ...
                        <div class="wt-dashboardboxcontent">
                            <div class="wt-jobdescription wt-tabsinfo">
                                ...
                                <div class="wt-formtheme wt-userform wt-userformvtwo la-job-details-form">
                                    ...
                                    <div class="form-group form-group-half" style="display:flex;">
                                        <input type="checkbox" id="show_participant_to_freelancer" name="show_participant_to_freelancer" class="form-control" style="height: 23px;width: 23px;margin-right: 23px;" @if($contest->show_participant_to_freelancer == 'yes') checked @endif>
                                        <label for="show_participant_to_freelancer">Show the list of participants to the freelancer</label>
                                    </div>
                                    <div class="form-group form-group-half" style="display:flex;">
                                        <input type="checkbox" id="show_participant_offer_to_freelancer" name="show_participant_offer_to_freelancer" class="form-control" style="height: 23px;width: 23px;margin-right: 23px;" @if($contest->show_participant_offer_to_freelancer == 'yes') checked @endif>
                            ...
                            <div class="wt-jobdescription wt-tabsinfo">
                                ...
                                <div class="wt-formtheme wt-userform wt-userformvtwo la-job-details-form">
                                    ...
                                    <div class="form-group" style="display:flex;margin-top: 20px;">
                                        <input type="text" id="awarded_allowed" name="awarded_allowed" class="form-control" placeholder="Number of freelancer Award allowed" value="{{ $contest->awarded_allowed }}">                         
                                    </div>
                                </div>
                            </div>
