            ...
            @php
                ...
                <div class="row" style="margin-left: 10px;padding-bottom: 15px;">
                    <ol class="wt-breadcrumb">
                        ...
                        <li class="active">{{ trans('lang.payout_settings')}}</li>
                    </ol>
                </div>
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-9">
                    <div class="wt-dashboardbox wt-dashboardtabsholder">
                        @if (file_exists(resource_path('views/extend/back-end/employer/payouts/tabs.blade.php')))
                            @include('extend.back-end.employer.payouts.tabs')
                        @else
                            @include('back-end.employer.payouts.tabs')
                        @endif
                                    ...
                                    @if( !empty($payrols) )
                                        @foreach ($payrols as $pay_key	=> $payrol)
                                            @php
                                                ...
                                                $checked =  !empty($payout_settings) && $payout_settings['type'] == $payrol['id'] ? 'checked' : '';
                                            @endphp
