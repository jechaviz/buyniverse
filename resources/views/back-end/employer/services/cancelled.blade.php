...
@section('content')
	...
	<div class="row"  style="margin-left: 10px;padding-bottom: 15px;">
                            <ol class="wt-breadcrumb">
                                ...
                                <li class="active">{{ trans('lang.cancelled_services')}}</li>
                            </ol>
                        </div>
		<div class="row">
									...
									@foreach ($services as $service)
										...
										<tr class="del-{{{ $service['status'] }}}">
											...
											<td data-th="Action">
												<span class="bt-content">
													<div class="wt-actionbtn">
														<a href="{{{url('employer/service/'.$service['id'].'/'.$service->pivot->id.'/cancelled')}}}" class="wt-viewinfo wt-btnhistory">{{ trans('lang.show_history') }}</a>
													</div>
												</span>
											</td>
										</tr>
