                                ...
                                @if ($access_type == 'jobs' || $access_type== 'both')
                                    @if (!empty($ongoing_projects) && $ongoing_projects->count() > 0)
                                        @foreach ($ongoing_projects as $projects)
                                            ...
                                            @endphp
                                            <tr>
                                                <td data-th="Project title"><span class="bt-content"><a target="_blank" href="{{{ url('provider/job/'.$project->job->slug) }}}">{{{ str_limit($project->job->title, 40) }}}</a></span></td>
                                                ...
                                                <td data-th="Actions">
                                                    <span class="bt-content"><div class="wt-btnarea"><a href="{{{ url('provider/job/'.$project->job->slug) }}}" class="wt-btn">{{ trans('lang.view_detail') }}</a></div></span>
                                                </td>
                                            </tr>
                                        @endforeach
                                    @endif
                                            ...
                                            <tr>
                                                <td data-th="Project title">
                                                    <span class="bt-content">
                                                        <a target="_blank" href="{{{ url('provider/service/'.$service->pivot_id.'/hired') }}}">
                                                ...
                                                <td data-th="Actions">
                                                    <span class="bt-content">
                                                        <div class="wt-btnarea">
                                                            <a href="{{{ url('provider/service/'.$service->pivot_id.'/hired') }}}" class="wt-btn">
