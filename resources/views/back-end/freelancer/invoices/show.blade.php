    ...
    @php
                        ...
                        <div class="row" style="margin-left: 10px;padding-bottom: 15px;">
                            <ol class="wt-breadcrumb">
                                ...
                                <li><a href="{{{ url($role.'/package/invoice') }}}">{{ trans('lang.invoices') }}</a></li>
                                <li class="active">{{ trans('lang.transaction_detl')}}</li>
                            </ol>
                        </div>
        <div class="row">
                ...
                <div class="wt-transactionhold">
                    ...
                    <div class="wt-transactioncontent" id="printable_area">
                        <ul class="wt-transactiondetails">
                            <li><span><em>{{{trans('lang.pay_rec')}}}</em> {{{trans('lang.from')}}} {{{$invoice_info->payer_name}}}</span><span class="wt-grossamount">{{{trans('lang.gross_amnt')}}}</span></li>
                            <li>
                                <span>
                                ...
                                @endif
                                <span class="wt-grossamount wt-grossamountusd">{{{ $symbol }}}{{{$invoice_info->price}}}&nbsp;{{{ $currency_code }}}</span>
                            </li>
                            <li>
                        ...
                        <table class="table wt-carttable">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td data-title="Total">{{ $symbol }}{{{ $invoice_info->item_price }}}&nbsp;{{ $currency_code }}</td>
                                    <td data-title="Total">{{ $symbol }}{{{ $invoice_info->item_price }}}&nbsp;{{ $currency_code }}</td>
                                </tr>
                                <tr>
                            ...
                            <tbody>
                                <tr>
                                    <td data-title="Product Name">
                                        ...
                                        <span>{{ $symbol }}{{{ $invoice_info->item_price }}}&nbsp;{{ $currency_code }}</span>
                                    </td>
                                    <td data-title="Unit Price"></td>
                                ...
                                <tr>
                                    <td data-title="Product Name">
                                        ...
                                        <span>{{ $symbol }}{{{$invoice_info->sales_tax}}} {{ $currency_code }}</span>
                                    </td>
                                    <td data-title="Unit Price"></td>
                                    <td data-title="Total"></td>
                                    <td data-title="Total"></td>
                                ...
                                <tr>
                                    <td data-title="Product Name">
                                        ...
                                        <span>{{ $symbol }}{{{$invoice_info->shipping_amount}}} {{ $currency_code }}</span>
                                    </td>
                                    <td data-title="Unit Price"></td>
                                    <td data-title="Total"></td>
                                    <td data-title="Total"></td>
                                ...
                                <tr>
                                    <td data-title="Product Name">
                                        ...
                                        <span>{{ $symbol }}{{{$invoice_info->handling_amount}}} {{ $currency_code }}</span>
                                    </td>
                                    <td data-title="Unit Price"></td>
                                    <td data-title="Total"></td>
                                    <td data-title="Total"></td>
                                ...
                                <tr>
                                    <td data-title="Product Name">
                                        ...
                                        <span>{{ $symbol }}{{{$invoice_info->insurance_amount}}} {{ $currency_code }}</span>
                                    </td>
                                    <td data-title="Unit Price"></td>
                                    <td data-title="Total"></td>
                                    <td data-title="Total"></td>
                                ...
                                <tr>
                                    <td data-title="Product Name">
                                        ...
                                        <span>{{ $symbol }}{{{$invoice_info->price}}} {{ $currency_code }}</span>
                                    </td>
                                    <td data-title="Unit Price"></td>
                                    <td data-title="Total"></td>
                                    <td data-title="Total"></td>
                        ...
                        <div class="wt-createtransactionhold wt-createtransactionholdvtwo">
                            ...
                            <div class="wt-refundscontent">
                                <ul class="wt-refundsdetails">
                                    ...
                                    @if ($invoice_info->payment_mode == "paypal")
