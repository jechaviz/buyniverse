...
@section('content')
	...
	<div class="row"  style="margin-left: 10px;padding-bottom: 15px;">
                            <ol class="wt-breadcrumb">
                                ...
                                <li class="active">{{ trans('lang.orders')}}</li>
                            </ol>
                        </div>
		<div class="row">
									...
									@foreach ($orders as $order)
										@php 
											...
											if ($order->type == 'job') {
												...
												$quiz = App\Quiz::find($order->product_id);
												$title = !empty($quiz->title) ? $quiz->title : '';
												$amount = !empty($quiz->price) ? $quiz->price : '';
											}
											...
											<tr class="del-{{{ $order->id }}}">
												...
												<td>
													<span class="bt-content wt-payment-tab">
														...
														@if ($order->invoice->transection_doc && Helper::getUnserializeData($order->invoice->transection_doc) != null)														
