    ...
    <div class="skills-listing" id="skill-list">
        ...
        <div class="row"  style="margin-left: 10px;padding-bottom: 15px;">
                            <ol class="wt-breadcrumb">
                                ...
                                <li class="active">{{ trans('lang.sub_skills')}}</li>
                            </ol>
                        </div>
            <div class="row">
                    ...
                    <div class="wt-dashboardbox">
                        ...
                        @if ($sub_skills->count() > 0)
                            <div class="wt-dashboardboxcontent wt-categoriescontentholder">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($sub_skills as $skill)
                                            <tr class="del-{{{ $skill->id }}}" v-bind:id="skillID">
                                                ...
                                                <td>{{{ $skill->sub_skill }}}</td>
                                                <td>
                                                    <div class="wt-actionbtn">
                                                        @if ($role === 'admin')
                                                        <a href="{{{ url('admin/sub-skills/') }}}/{{{ $skill->id }}}/edit" class="wt-addinfo wt-skillsaddinfo">
                                                            <i class="lnr lnr-pencil"></i>
                                                        </a>
                                                        <form action="{{ route('sub-skills.destroy', $skill->id) }}" method="POST">
                                                        ...
                                                        @else
                                                        <a href="{{{ url('employer/sub-skills/') }}}/{{{ $skill->id }}}/edit" class="wt-addinfo wt-skillsaddinfo">
                                                            <i class="lnr lnr-pencil"></i>
                                                        </a>
                                                        @endif
                                                    </div>
                                ...
                                @if ( method_exists($sub_skills,'links') )
                                    {{ $sub_skills->links('pagination.custom') }}
                                @endif
                            </div>
                        @else
