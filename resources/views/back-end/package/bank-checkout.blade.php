...
@section('content')
                            ...
                            <table class="sj-checkouttable wt-ordertable">
                                ...
                                <tbody>
                                    ...
                                    @if($job->project_type == 'hourly')
                                        <tr>
                                            <td>{{ trans('lang.set_hours') }}</td>
                                            <td><input type="number" id="hours" onchange="set_hours(this.value, {{$cost}})"></td>
                                        </tr>
                                    @endif
                                    @endif
    ...
    <script>
        function set_hours(value, cost) {
            //console.log(value, cost);
            document.getElementById("total").innerText=value*cost;
            document.getElementById("total_cost").value=value*cost;
        }
    </script>
@endsection