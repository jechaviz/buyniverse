...
Vue.filter('formatPriority', function(value) {    
    switch(value)
    {
...
Vue.filter('formatClient', function(value) {    
    switch(value)
    {
...
Vue.filter('formatMilestone', function(value) {
...
window.deleteVue = createApp({});
window.flashMessageVue = createApp({});
...
app.component('upload-file', require('./components/UploadFileComponent.vue').default);
app.component('upload-image', require('./components/UploadImageComponent.vue').default);
app.component('flash_messages', require('./components/FlashMessages.vue').default);
app.component('switch_button', require('./components/SwitchButton.vue').default);
app.component('user_skills', require('./components/ProfileSkillComponent.vue').default);
app.component('user_category', require('./components/ProfileCategoryComponent.vue').default);
app.component('page-order', require('./components/PageOrderComponent.vue').default);
app.component('provider_experience', require('./components/ProfileExperienceComponent.vue').default);
app.component('provider_education', require('./components/ProfileEducationComponent.vue').default);
app.component('provider_project', require('./components/ProfileProjectComponent.vue').default);
app.component('provider_award', require('./components/ProfileAwardComponent.vue').default);
app.component('job_attachments', require('./components/UploadJobAttachmentComponent.vue').default);
app.component('job_multiple-attachments', require('./components/JobMultipleAttachmentComponent.vue').default);
app.component('job_skills', require('./components/JobSkillComponent.vue').default);
app.component('private-message', require('./components/PrivateMessageComponent.vue').default);
app.component('rating', require('./components/RatingComponent.vue').default);
app.component('search-form', require('./components/SearchComponent.vue').default);
...
app.component('conversation', require('./components/admin/ConversationComponent.vue').default);
app.component('chat', require('./components/Chat.vue').default);
app.component('chat-users', require('./components/ChatUserComponent.vue').default);
app.component('chat-users1', require('./components/ChatUserComponent1.vue').default);
app.component('chat-messages', require('./components/ChatMessageComponent.vue').default);
app.component('chat-area', require('./components/ChatAreaComponent.vue').default);
app.component('message-center', require('./components/ChatComponent.vue').default);
app.component('message-center1', require('./components/ChatComponent1.vue').default);
app.component('emoji-textarea', require('./components/emojiTexeareaComponent.vue').default);
app.component('delete', require('./components/DeleteRecordComponent.vue').default);
app.component('countdown', require('./components/CountdownComponent.vue').default);
app.component('experience', require('./components/ProviderExperienceComponent.vue').default);
app.component('education', require('./components/ProviderEducationComponent.vue').default);
app.component('crafted_project', require('./components/ProviderCraftedProjetcsComponent.vue').default);
app.component('custom-map', require('./components/map.vue').default);
app.component('dashboard-icon', require('./components/DashboardIconUploadComponent.vue').default);
app.component('image-attachments', require('./components/UploadServiceAttachmentComponent.vue').default);
app.component('provider-reviews', require('./components/ProviderReviewsComponent.vue').default);
app.component('job-expiry', require('./components/JobExperyComponent.vue').default);
app.component('second-slider', require('./components/pages/show/sections/sliders/style2.vue').default);
app.component('third-slider', require('./components/pages/show/sections/sliders/style3.vue').default);
app.component('page-media', require('./components/PageAttachmentComponent.vue').default)
app.component('custom-link', require('./components/CustomLinkComponent.vue').default);
// New page Builder
app.component('create-new-page', require('./components/pages/create.vue').default);
app.component('edit-new-page', require('./components/pages/edit.vue').default);
app.component('show-new-page', require('./components/pages/show/show.vue').default);
app.component('search-form-v2', require('./components/SearchComponentV2.vue').default);

app.component('slider-skeleton', require('./components/pages/show/skeleton/slider.vue').default);
...
if (document.getElementById("pages-list")) {
    app.mount('#pages-list');
    /*const vmpageList = createApp({
        el: '#pages-list',
        mounted: function () {
            if (document.getElementsByClassName("flash_msg") != null) {
                flashVue.$emit('showFlashMessage');
...
if (document.getElementById("jobs")) {
    const jobVue = createApp({
        ...
        data: {
            ...
            proposal: {
                amount: $trans('lang.enter_proposal_amount'),
                deduction: '00.00',
                total: '00.00',
                completion_time: '',
                description: '',
