                ...
                <div class="wt-categoryexpl">
                    <div class="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-3 float-left" v-for="(cat, index) in categoryList" :key="index">
                        <div class="wt-categorycontent">
                            <figure><img :src="baseUrl+'/public/uploads/categories/'+ cat.image" :alt="cat.title"></figure>
...
export default {
    ...
    mounted: function() {
        this.isActive = false
        var self= this
        this.emitter.on('category-section-update', (data) => {
            setTimeout(function(){ 
    ...
    created: function() {
        ...
        setTimeout(function(){ 
            ...
            //var index = "<?php echo" . getArrayIndex(self.categories, 'id', self.element_id) ."?>";
