        ...
        <div class="container-fluid">
            <div class="row">
                <carousel id="wt-freelancers-silder" class="wt-freelancers-silder" 
                    ...
                    v-if="filtersApplied">
                    <div class="wt-freelancer" v-for="(provider, index) in topProviders" :key="index">
                        ...
                        <div class="wt-freelancer-head">
                            ...
                            <div class="wt-freelancer-about">
                                <div class="wt-freelancer-price"><span><i class="fas fa-money-bill-alt"></i> {{provider.symbol}}{{provider.hourly_rate}} / hr </span></div>
                                <div class="wt-rating">
                        ...
                        <ul class="wt-freelancer-footer">
                            ...
                            <li v-else>
                                <a href="javascript:void(0);" class="wt-savefreelancer" :id="'provider-'+provider.id" @click.prevent="add_wishlist('provider-'+provider.id, provider.id, 'saved_provider')">
