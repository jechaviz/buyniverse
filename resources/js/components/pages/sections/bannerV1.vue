...
export default {
    ...
    mounted: function() {
        ...
        this.emitter.on('banner-section-update', (data) => {
            setTimeout(function(){ 
                self.isActive = !self.isActive;
            }, 10);
        })
        
        this.emitter.on('new-banner-front-image'+self.element_id, (data) => {
            this.newFrontImage = true
        })
        
        this.emitter.on('new-banner-bg-image'+self.element_id, (data) => {
