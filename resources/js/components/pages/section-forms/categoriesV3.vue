    ...
    <div class="element-form-wrapper" v-if="category">
        <div class="amt-formcontactus">
            <fieldset>
                ...
                <div class="form-group">
                    <input type="text" v-model="category.titleTwo" :placeholder="$trans('lang.sec_title_two')" class="form-control">
                </div>
                <div class="form-group">
        ...
        <div class="amt-element-title amt-element-titlecontent">
            ...
            <verte menuPosition="right" model="hex" v-model="category.titleTwoColor"></verte>
        </div>
        <div class="amt-element-title amt-element-titlecontent">
