      ...
      <div class="at-verticalscrollbar">
        <form method="POST" id="pages" class="wt-formtheme wt-formprojectinfo wt-formcategory" @submit.prevent="submitPage()">
          <div class="amt-sidebar-section-wrap" id="amt-sidebar-section-wrap">
            ...
            <div class="amt-section-select" v-if="form.body && form.body !== 'null'">
            ...
            <div class="amt-section-footer">
              ...
              <div id="at-collapse-switches" class="amt-switches-options collapse show">
                <page-data :form="form" :parentPages="parentPages" :pageID="form.id" :has_child="has_child"/>
              </div>
            </div>
          </div>
...
export default {
  props:['sections_list','page_id','access_type', 'app_styles','parent_pages', "selected_parent", "has_child", "seo_desc", 'slider_styles'],
  order: 5,
  components: {
  ...
  methods: {
      ...
      axios
        ...
        .then(function (response) {
          if (response.data.type == 'success') {
            ...
            self.form.meta.title.show = self.pageData.show_page_title == 1 ? true :false
            self.form.meta.header = self.pageData.header
            self.form.meta.footer = self.pageData.footer
            self.form.meta.page_order = self.pageData.page_order
            self.form.headerStyling = (self.pageData.header_styling) ? self.pageData.header_styling : self.form.headerStyling
    ...
    boolean whether id exist in array
    or not
    */
      ...
      if (evt.added) {
        if (evt.added.element.section == 'heading') {
          ...
          var service = {
            ...
            description:'Service desccription',
            sectionColor: '#ffffff',
            titleColor:'#3d4461',
            subtitleColor:'#3d4461',
            padding: {
          ...
          this.form.meta.services.push(service)
            ...
            var work = {
              ...
              description:'Work Tab section desc',
              background_image:'',
              first_tab_icon:'',
              second_tab_icon:'',
              third_tab_icon:'',
            ...
            var work = {
              ...
              description:'Work Video section desc',
              video_poster:'',
              video_link:'',
              sectionColor: '#ffffff',
              titleColor:'#3d4461',
