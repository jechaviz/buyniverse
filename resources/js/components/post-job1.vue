            ...
            <div class="col-md-7">
                ...
                <div style="margin: 30px;" id="editdescription" class="hidden" >
                    ...
                    <form @submit.prevent="Updatedescription()">
                        ...
                        <tinymce id="datadescription" v-model="formd.description" :other_options="{height:600}" ref="tm"></tinymce>
                ...
                <table style="margin-top: 30px;">
                    ...
                    <tr id="tr3" class="hidden">
                        ...
                        <td class="job-details">
                            <span id="price" class="hidden" @click="editprice">  $ {{ $filters.numFormat(form.price) }} <i class="fa fa-pencil" style="float:right;margin: 10px;"></i></span>
                    ...
                    <tr id="tr14" class="hidden">
                        ...
                        <td class="job-details">
                            <span @click="editexpirydate" v-if="job1.delivery_type == 'date'">
                                <span id="expirydate">{{ $filters.formatDate(job1.expiry_date) }} <i class="fa fa-pencil" v-show="isapprover == '1' || permission == 2" style="float:right;margin: 10px;"></i></span>
 ...
 data () {
  ...
  methods: {
        ...
        posttitle() {
            ...
            axios.post(APP_URL + '/job/job-post', form_data)
                .then(function (response) {
                    ...
                    self.formd.job_id = response.data.id;
                });
        },
        deliverychange() {
            let self = this;
        ...
        Updatedescription() 
        {
            ...
            this.formd.post('/api/job_overview/description/'+ this.job_id)
            .then(() => {
                Swal.fire({
                    icon: 'success',
        ...
        updateaddskill(e) {
            let self = this;
            var check = 0;
            let statp =  self.job_id + '-' + e.target.value;
