<template>
    <form class="wt-formtheme wt-formbanner wt-formbannertwo" 
        :class="style_type == 'new' ? 'wt-newformbanner' : ''"
        ...
        <fieldset>
            ...
            <div class="form-group">
                ...
                <div class="wt-formoptions">
                    <a href="#" class="wt-searchbtn" v-on:click.prevent="submitSearchForm(types)" v-if="style_type == 'new'"><i class="lnr lnr-magnifier"></i>Search</a>
                    <a href="#" class="wt-searchbtn" v-on:click.prevent="submitSearchForm(types)" v-else><i class="lnr lnr-magnifier"></i></a>
                </div>
            </div>
        </fieldset>
    </form>
