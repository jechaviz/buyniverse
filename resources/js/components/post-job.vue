    ...
    <div id="trx" class="wt-dashboardbox hidden">
          ...
          <tr id="tr4" class="hidden">
              ...
              <td @click="editprice" class="job-details">
                    <span id="price"> <span v-if="job1.currency">{{ job1.curr.symbol }}</span>  {{ $filters.numFormat(job1.price) }} <i class="fa fa-pencil"  style="float:right;margin: 10px;"></i></span>
