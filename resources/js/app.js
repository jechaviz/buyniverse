...
Vue.component('chat-users1', require('./components/ChatUserComponent1.vue').default);
...
Vue.component('message-center1', require('./components/ChatComponent1.vue').default);
