    ...
    getHeaderStyles (key = '') {
      let list = {
        '1': {
          ...
          'value': 'style1',
          'img' : APP_URL+'/public/images/page-builder/headers/header1.jpg'
        },
        '2': {
          'title': this.trans('lang.style02'),
          'value': 'style2',
          'img' : APP_URL+'/public/images/page-builder/headers/header2.jpg'
        },
        '3': {
          'title': this.trans('lang.style03'),
          'value': 'style3',
          'img' : APP_URL+'/public/images/page-builder/headers/header3.jpg'
        },
        '4': {
          'title': this.trans('lang.style04'),
          'value': 'style4',
          'img' : APP_URL+'/public/images/page-builder/headers/header4.jpg'
        },
        '5': {
          'title': this.trans('lang.style05'),
          'value': 'style5',
          'img' : APP_URL+'/public/images/page-builder/headers/header5.jpg'
        }
      }
      if (key && (key in list)) {
        return list[key]
    ...
    getFooterStyles (key = '') {
      let list = {
        '1': {
          'title': this.trans('lang.style01'),
          'value': 'style1',
          'img' : APP_URL+'/public/images/page-builder/footers/footer1.jpg'
        },
        '2': {
          'title': this.trans('lang.style02'),
          'value': 'style2',
          'img' : APP_URL+'/public/images/page-builder/footers/footer2.jpg'
        },
        '3': {
          'title': this.trans('lang.style03'),
          'value': 'style3',
          'img' : APP_URL+'/public/images/page-builder/footers/footer3.jpg'
        },
      }
      if (key && (key in list)) {
        return list[key]
